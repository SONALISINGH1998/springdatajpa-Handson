...
public class CountryService {
	...
	@Transactional
	public List<Country> charactersMatchingCountries(String code) throws CountryNotFoundException{
		return countryRepository.findByNameContainsOrderByNameAsc(code);
		
	}
	@Transactional
	public List<Country> ascendingOrderCountries() throws CountryNotFoundException{
